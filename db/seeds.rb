...
User.new(:email=>'admin@admin.com', :password=>'piscos', :password_confirmation =>'piscos', :first_name=>'admin', :second_name=>'mandon', :adress=>'mi calle', :phone=> 928666666).save
...
User.new(:email=>'cocinero@cocinero.com', :password=>'cocinero', :password_confirmation =>'cocinero', :first_name=>'cocinero', :second_name=>'negro', :adress=>'mi calle', :phone=> 666666666).save
...
Product.new(:image_url=>'aceituna.jpg', :title=>'Sandwich de aceitunas', :description =>'<p>Sandwich con deliciosas aceitunas molidas, pimiento, mayonesa, atun y guisantes.</p>', :price=> 1.50, :available=> true, :type_id=> 1).save
...
Product.new(:image_url=>'pack.jpg', :title=>'Bandeja variada', :description =>'<p>Bandeja con una seleccion de nuestros mejores productos</p>', :price=>10.50, :available=> true, :type_id=>1).save
...
Product.new(:image_url=>'rollitos_de_pollo.jpg', :title=>'Rollito de pollo al ajillo', :description =>'<p>Delicioso pollo asado molido al ajillo con mayonesa.</p>', :price=>2, :available=> true, :type_id=>4).save
